...
Page({
  ...
  onMaxPerUserChange(e)  { this.setData({ max_per_user: e.detail.value ? 1 : 0 }) },
  ...
  async onSave() {
    const { id, catIds, catIndex, name, description, priceYuan, price_unit, is_active, needs_co_hunter, max_per_user, formFields } = this.data
