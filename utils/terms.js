...
const TERMS = REVIEW_MODE ? {
  ...
  // 申请/切换
  applyHunter:    '申请成为打手',
  applyHunterNick:'打手昵称',
  switchToHunter: '打手登录',
  switchToBoss:   '切换到老板模式',
  hunterWorkbench:'进入打手工作台，接单与收入',
  hunterMgmt:     '订单、服务、打手审核等',
  // 订单
  settle:         '结单',
  settleBtn:      '确认结单',
  ...
  thisHunter:     '本单打手',
  confirmSettle:  '确认后订单完成，将按该打手当前分成比例结算入账（可提现）。',
  rejectHint:     '请说明打手需如何修改',
  submittedHint:  '已提交结单，等待管理员审核通过后入账',
  // 管理
  activeHunters:  '在职打手',
  noActiveHunters:'暂无在职打手',
  dismissTitle:   '解雇打手',
  payHunterHint:  '确认已向打手微信号完成转账？',
  rulesTitle:     '老板须知',
  // 首页 slogan
  slogan:         '你的金牌护航',
  sloganTag:      '🏆 全程护航',
